...
class ExamsPage(QWidget):
    ...
    def _build_ui(self):
        ...
        self.btn_calculator = QPushButton("🧮 Hedef Not Hesaplayıcı")
        self.btn_calculator.setCursor(Qt.CursorShape.PointingHandCursor)
        self.btn_calculator.setStyleSheet("background-color: #00e5a0; color: #111318; border-radius: 8px; padding: 10px 20px; font-weight: bold;")
        self.btn_calculator.clicked.connect(self.open_grade_calculator)
        header_top.addWidget(self.btn_calculator)
        ...
        btn_box.addWidget(self.btn_delete_exams)
        
        view_layout.addLayout(btn_box)
